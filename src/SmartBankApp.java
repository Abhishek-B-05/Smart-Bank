...
public class SmartBankApp {
    ...
    private static final String DB_URL = "jdbc:postgresql://main-smart-bank.d.aivencloud.com:13580/defaultdb?ssl=require";
    private static final String DB_USER = "avnadmin";
    private static final String DB_PASS = "AVNS_5tO0K7qLe8fb038wcMs";
        ...
        try {
            ...
            while (running) {
                ...
                switch (choice) {
                    ...
                    case 3 -> {
                        running = false;
                        System.out.println("👋 Exiting SmartBank........\n   Goodbye!");
                    }
